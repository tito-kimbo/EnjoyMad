...
public class LocationFilterTest {
	...
	/**
	 * This method checks that the JSON reading from url process is exception
	 * free for random chosen coordinates.
	 */
	// @Test
	 ...
	 * 
	 * That two GPS coordinates are just 1.8km away. The final assert should be
	 * true.
	 */
	@Test
	public void getDistanceFrom2GpsPoints() {
		FilterMapper.addAll();
		ClubPOJO club = new ClubPOJO("id", "name", "calle", 0, new Location(0,
				0), 0);
		LocationFilterBO filter = new LocationFilterBO("5", "38.948706",
				"-2.544259");
