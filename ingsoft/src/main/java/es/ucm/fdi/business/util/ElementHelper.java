...
/**
 * This class is designed to hold search results, indicating whether a possible
 * match is or not visible in the current search.
 *
 * @param <T>
 *            Type of the content of the class.
 * @version 22.04.2018
 */
public class ElementHelper<T> {
	 ...
	 * 
	 * @param e
	 *            Element contained in this object.
	 */
