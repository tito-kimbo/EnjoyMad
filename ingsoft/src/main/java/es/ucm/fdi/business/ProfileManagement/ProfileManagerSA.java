...
public interface ProfileManagerSA {
	...
	*/
	...
	/**
	 * <p>
	 * Adds a new or modified user <code>Rate</code> and recalculates 
	 * the club's total <code>Rating</code>.
	 * </p> <p>
	 * <code>Club</code> receives <code>Rate</code> from <code>User</code>.
	 * </p>
	 * 
	 * @param clubID <code>ID</code> of rated <code>Club</code>
	 * @param rate <code>Integer</code> with user <code>Rate</code>
	 * @param userID <code>ID</code> of the rating <code>User</code>
	 * 
	...
	/**
	 * <p>
	 * Adds a new or modified user <code>Opinion</code>.
	 * </p> <p>
	 * <code>Club</code> receives <code>Opinion</code> from <code>User</code>.
	 * </p>
	 * 
	 * @param clubID <code>ID</code> of reviewed <code>Club</code>
	 * @param opinion <code>String</code> with user <code>Opinion</code>
	 * @param userID <code>ID</code> of the reviewing <code>User</code>
	 * 
	 * @throws NoSuchElementException if <code>userID, clubID</code> not found in <code>userDAO, clubDAO</code> databases
	 * @throws DataFormatException if <code>opinion</code> parsing failed
	 */
	...
	/**
	 * <p>
	 * Removes a user <code>Rate</code>.
	 * </p> <p>
	 * <code>Club</code> deletes <code>Rate</code> from <code>User</code>.
	 * </p>
	 * 
	 * @param clubID id of club
	 * @param userID <code>ID</code> of <code>User</code>
	 * 
	 * @throws NoSuchElementException if <code>userID, clubID</code> not found in <code>userDAO, clubDAO</code> databases
	 */
	...
	/**
	 * <p>
	 * Removes a user <code>Opinion</code>.
	 * </p> <p>
	 * <code>Club</code> deletes <code>opinion</code> from <code>User</code>.
	 * </p>
	 * 
	 * @param clubID id of club
	 * @param userID <code>ID</code> of <code>User</code>
